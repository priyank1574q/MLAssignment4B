...
clf_entropy = DecisionTreeClassifier(criterion="entropy",splitter='best',random_state=0,max_depth=None,min_samples_leaf=65)
...
for i in range(len(b)):
    clf_entropy = DecisionTreeClassifier(criterion="entropy",splitter='best',random_state=0,max_depth=None,min_samples_leaf=b[i])
    clf_entropy.fit(x_train, y_train)
